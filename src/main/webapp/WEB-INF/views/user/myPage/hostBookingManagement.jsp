...
<section class="screens-user-myPage-hostBookingManagement__section">
    <div class="screens-user-myPage-hostBookingManagement__container">
        <div class="screens-user-myPage-hostBookingManagement__newBookings screens-hostBookingManagement-flex-column">
            <div class="screens-user-myPage-hostBookingManagement__newBookings-banner1"><p>예약신청</p></div>
            <div class="screens-user-myPage-hostBookingManagement__requests screens-hostBookingManagement-flex-column">
                <div class="screens-user-myPage-hostBookingManagement__request screens-hostBookingManagement-flex-column">
                    ...
                    <div class="screens-user-myPage-hostBookingManagement__request__btn screens-hostBookingManagement-flex-row">
                        <div class="screens-user-myPage-hostBookingManagement__request__agreeBtn"><img
                                src="/resources/img/symbol/check-square-svgrepo-com.svg" alt="승인"></div>
                        <div class="screens-user-myPage-hostBookingManagement__request__disagreeBtn"><img
                                src="/resources/img/symbol/x-square-svgrepo-com.svg" alt="거부"></div>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function fillRequests(list) {
        list.forEach(function (component) {
            ...
            cloneElement.querySelector('.screens-user-myPage-hostBookingManagement__request__roomName > div:nth-of-type(1) > p').textContent = component.r_room_name;
            cloneElement.querySelector('.screens-user-myPage-hostBookingManagement__request__period > div:nth-of-type(1) > p').textContent = checkinDate + `\u00a0\u00a0\u00a0~\u00a0\u00a0\u00a0\u00a0` + checkoutDate;
            cloneElement.querySelector('.screens-user-myPage-hostBookingManagement__request__userName > div:nth-of-type(1) > p').textContent = component.u_user_name;
            cloneElement.querySelector('.screens-user-myPage-hostBookingManagement__request__peopleNum > div:nth-of-type(1) > p').textContent = component.b_booking_num_of_guest + " 명 ";
            cloneElement.querySelector('.screens-user-myPage-hostBookingManagement__request__totalPay > div:nth-of-type(1) > p').textContent = formatKoreanCurrency(component.b_booking_total_pay_amount) + "원";
            cloneElement.querySelector('.screens-user-myPage-hostBookingManagement__request__telNum > div:nth-of-type(1) > p').textContent = component.u_user_phone_num1;
            cloneElement.querySelector('.screens-user-myPage-hostBookingManagement__request__agreeBtn > img').addEventListener("click", function () {
            ...
            cloneElement.querySelector('.screens-user-myPage-hostBookingManagement__request__disagreeBtn > img').addEventListener("click", function () {
