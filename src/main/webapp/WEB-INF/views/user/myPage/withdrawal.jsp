...
<div class="screens-user-withdrawal__wrapper">
    ...
    <ul class="screens-user-withdrawal__info-4">
        <li class="screens-user-withdrawal__li">계정 삭제를 요청하시면 더 이상 에어비앤비 계정을 사용하실 수 없으며, 계정이 영구적으로
            해지됩니다.
        </li>
        <li class="screens-user-withdrawal__li">계정 사용을 일시적으로 중단하고 싶으시다면 에어비앤비 계정을 비활성화하실 수 있습니다.
        </li>
    </ul>
