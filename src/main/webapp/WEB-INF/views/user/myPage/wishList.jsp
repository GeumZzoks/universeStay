        ...
        <c:forEach var="wishListDto" items="${list}">
            ...
            <div id="${wishListDto.room_id}" class="modal-div"
                ...
                <h4 style="float: left; color: #717171; margin-top: 6px; width: 190px;"><br><br>
                    <h3 style="float: left; font-size: 14px; font-weight: 500; margin-top: 10px; width: 180px; height: 12px; overflow: hidden; text-overflow: ellipsis; white-space:nowrap;">${wishListDto.room_name}</h3>
                </h4>
            </div>
