...
<head>
    ...
    <style>
      ...
      .screens-user-reservation__text-size-reservation-room-info-h2 {
      ...
      .screens-user-reservation__container__flex {
        display: flex;
      ...
      .screens-user-reservation__container__right-side__review {
        font-size: 0.75rem;
        font-family: NotoSansKR-Light;
      }

      .screens-user-reservation__container__right-side__review span {
        font-family: NotoSansKR-Medium;
      }

      .screens-user-reservation__container__right-side__review--bigger {
        font-size: 0.875rem;
      }

      .screens-user-reservation__container__right-side__flex-box-column__total-payment {
        display: flex;
        justify-content: space-between;
        align-items: center;
      ...
      .screens-user-reservation__container__left-side--space-topdown__header__img {
        width: 100px;
        width: 50px;
        overflow: hidden;
      ...
      .screens-user-reservation__container__left-side--space-topdown__header__img img {
        width: 100%;
        height: 100%;
        border-radius: 8px;
      }
