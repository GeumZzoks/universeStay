...
<body>
    <div class="screens-user-withdrawal__wrapper">
        ...
        <ul class="screens-user-withdrawal__info-3">
            ...
            <li class="screens-user-withdrawal__li">요청이 처리되면 에어비앤비가 보유하고 있는 사용자의 모든 개인정보가 삭제됩니다.
        ...
        <img class="screens-user-withdrawal__img-caution" src="../../../resources/img/symbol/caution.png" alt="">

        <h2 class="screens-user-withdrawal__h2">계정을 삭제하시겠어요?</h2>
        <ul class="screens-user-withdrawal__info-4">
            <li class="screens-user-withdrawal__li">계정 삭제를 요청하시면 더 이상 에어비앤비 계정을 사용하실 수 없으며, 계정이 영구적으로 해지됩니다.</li>
            <li class="screens-user-withdrawal__li">계정 사용을 일시적으로 중단하고 싶으시다면 에어비앤비 계정을 비활성화하실 수 있습니다.</li>
        </ul>
        ...
        <div class="screens-user-withdrawal__box-back-delete">
            ...
            <button class="screens-user-withdrawal__box-back-delete__btn-delete" onclick="withdrawalUser()">계정삭제</button>
