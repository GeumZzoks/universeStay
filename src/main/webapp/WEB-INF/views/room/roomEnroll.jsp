...
<div class="screens-room-roomEnroll__wrapper">
    ...
    <div class="screens-room-roomEnroll__info-basic">
        <div class="screens-room-roomEnroll__info-basic__guest">
            ...
            <div class="screens-room-roomEnroll__info-basic__info-2">
                ...
                <input type="text" class="screens-room-roomEnroll__info-basic__num"
                       name="room_standard_capa" value='1' readonly/>
        ...
        <div class="screens-room-roomEnroll__info-basic__guest-max">
            ...
            <div class="screens-room-roomEnroll__info-basic__info-2">
                ...
                <input type="text" class="screens-room-roomEnroll__info-basic__num"
                       name="room_max_capa" value='1' readonly/>
                <button class="screens-room-roomEnroll__info-basic__btn-plus">
                    <svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                         role="presentation" focusable="false"
                         style="display: block; height: 12px; width: 12px; fill: currentcolor;">
        ...
        <div class="screens-room-roomEnroll__info-basic__bedroom">
            ...
            <div class="screens-room-roomEnroll__info-basic__info-2">
                ...
                <input type="text" class="screens-room-roomEnroll__info-basic__num"
                       name="room_bedroom_cnt" value='1' readonly/>
                <button class="screens-room-roomEnroll__info-basic__btn-plus">
                    <svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                         role="presentation" focusable="false"
                         style="display: block; height: 12px; width: 12px; fill: currentcolor;">
        ...
        <div class="screens-room-roomEnroll__info-basic__bed">
            ...
            <div class="screens-room-roomEnroll__info-basic__info-2">
                ...
                <input type="text" class="screens-room-roomEnroll__info-basic__num"
                       name="room_bed_cnt" value='1' readonly/>
                <button class="screens-room-roomEnroll__info-basic__btn-plus">
                    <svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                         role="presentation" focusable="false"
                         style="display: block; height: 12px; width: 12px; fill: currentcolor;">
        ...
        <div class="screens-room-roomEnroll__info-basic__bathroom">
            ...
            <div class="screens-room-roomEnroll__info-basic__info-2">
                ...
                <input type="text" class="screens-room-roomEnroll__info-basic__num"
                       name="room_bathroom_cnt" value='1' readonly/>
                <button class="screens-room-roomEnroll__info-basic__btn-plus">
                    <svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"
                         role="presentation" focusable="false"
                         style="display: block; height: 12px; width: 12px; fill: currentcolor;">
    ...
    <%--    TODO : 포토 추가 기능    --%>
    <div class="screens-room-roomEnroll__photos"></div>

    <%--  숙소 이름을 지어주세요  --%>
    <div class="screens-room-roomEnroll__title">숙소 이름을 지어주세요</div>
    <input class="screens-room-roomEnroll__room-name" type="text">

    <%--  숙소 장점을 적어주세요  --%>
    <div class="screens-room-roomEnroll__title">숙소 장점을 적어주세요</div>
    <input name="room_advantages_desc" class="screens-room-roomEnroll__room-advantages-desc"
           type="text">

    <%--  숙소 공간에 대해 설명해주세요  --%>
    <div class="screens-room-roomEnroll__title">숙소 공간에 대해 설명해주세요</div>
    <input name="room_space_desc" class="screens-room-roomEnroll__room-space-desc" type="text">

    <%--  숙소 기타 참고할점을 적어주세요  --%>
    <div class="screens-room-roomEnroll__title">숙소 기타 참고할점을 적어주세요</div>
    <input name="room_stc_desc" class="screens-room-roomEnroll__room-stc-desc" type="text">
