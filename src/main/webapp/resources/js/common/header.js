...
document.addEventListener("click", function (e) {
  ...
  if (e.target.classList.contains("header__searchbar__main_txt") ||
      e.target.classList.contains("header__searchbar__sub_txt") ||
      e.target.classList.contains("header__profile__my-profile") ||
      e.target.classList.contains("header__profile__my-profile__btn") ||
      e.target.classList.contains("header__profile__hamburger") ||
      e.target.classList.contains("header__profile__img")
  ) {
    return;
  }
