...
public class InquiryController {
    ...
    public String writeReply(RedirectAttributes rattr, SearchCondition sc, Integer inquiry_id,
            String reply_writer_id, String reply_ctt) {
...
//        rattr.addAttribute("sc", sc.getQueryString());
    ...
    public String deleteReply(SearchCondition sc, int inquiry_id, int reply_id,
        ...
        return "redirect: /admin/inquiry/details" + sc.getQueryString() + "&inquiry_id="
                + inquiry_id;
    }

    @PostMapping("/updatereply")
    public String updateReply(SearchCondition sc, String reply_ctt, String updated_id,
            int inquiry_id, int reply_id, RedirectAttributes rattr) {
        try {
